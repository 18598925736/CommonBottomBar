package com.example.gc_hank.evolutionpro.ui.util;
...
public class DeviceUtil {
     ...
     * @return int 屏幕像素值
     */
    public int dp2px(float dpValue, Context activity) {
        return (int) (dpValue * getScreenDensity(activity) + 0.5f);
    }
     ...
     * @return int 屏幕dp值
     */
    public int px2dp(float pxValue, Context activity) {
